...
| Русский                             | [Документация](#russian)                 |
| 日本語                               | [ドキュメンテーション](#japanese)           |
| Русский дореформенный               | [Документація](#old_russian)             |
| Esperanto                           | [Dokumentado](#esperanto)                |
| Українська                          | [Документація](#ukrainian)               |
| Latine                              | [Documentatio](#latin)                   |
| Русский стихотворный                | [Документация в стихах](#poetic_russian) |
| "Горе от кода"                      | ["Горе от кода"](#gore_ot_koda)          |
|"Горе от кода" (в пересказе DeepSeek)|["Горе от кода"](#gore_ot_koda_v2)        |
